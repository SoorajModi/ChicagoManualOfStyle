import {
  newspaperBibliography,
  newspaperNote,
} from "../../src/Newspaper/newspaper";
...
describe("Newspaper.note() testing", () => {
  it("should generate newspaper note with all fields specified", () => {
    expect(newspaperNote(newspaper)).toBe(
      'First Last, "Article Title," Newspaper Title, Date, Edition.'
    );
  });

  it("should generate newspaper note with no edition specified", () => {
    expect(newspaperNote(noEdition)).toBe(
      'First Last, "Article Title," Newspaper Title, Date.'
    );
  });

  it("should generate newspaper note with URL", () => {
    expect(newspaperNote(url)).toBe(
