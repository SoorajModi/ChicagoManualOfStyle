...
describe("Film.filmNote() testing", () => {
  it("should generate film note citation", () => {
    expect(filmNote(film, "")).toBe(
      "Title, directed by First Last (Original Release Date; City: Studio/Distributor, Video Release Year), Medium."
    );
  });

  it("should generate file note citation with no director specified", () => {
    expect(filmNote(noDirector, "")).toBe(
      "Title, (Original Release Date; City: Studio/Distributor, Video Release Year), Medium."
    );
  });
...
describe("Film.filmBibliography() testing", () => {
  it("should generate film bibliography citation", () => {
    expect(filmBibliography(film)).toBe(
  ...
  it("should generate film bibliography citation with no director specified", () => {
    expect(filmBibliography(noDirector)).toBe(
      "Title. Original Release Date; City: Studio/Distributor, Video Release Year. Medium."
    );
  });
