...
let info: LectureInfoInterface = {
  university: 'University', city: 'City', province: 'Province', date: 'Date',
};
let missingUni = {
  university: '', city: 'City', province: 'Province', date: 'Date',
};
let missingCity = {
  university: 'University', city: '', province: 'Province', date: 'Date',
};
let missingProvince = {
  university: 'University', city: 'City', province: '', date: 'Date',
};
let missingDate = {
  university: 'University', city: 'City', province: 'Province', date: '',
};
let missingLocation = {
  university: '', city: '', province: '', date: 'Date',
};
let emptyInfo = {
  university: '', city: '', province: '', date: '',
};
