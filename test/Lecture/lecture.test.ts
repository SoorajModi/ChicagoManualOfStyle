...
let lecture = {
  title: 'Course', professors: [{ first: 'First', last: 'Last' }], university: 'University', province: 'Province', city: 'City', date: 'Date',
};
let noProf = {
  title: 'Course', university: 'University', province: 'Province', city: 'City', date: 'Date',
};
...
describe('Lecture.note() should generate note citation', () => {
  ...
  it('should generate note citation with no professor specified', () => {
    expect(lectureNote(noProf)).toBe('"Course" (lecture, University, City, Province, Date).');
  });
});
...
describe('Lecture.bibliography() should generate bibliography citation', () => {
  ...
  it('should generate bibliography citation with no professor specified', () => {
    expect(lectureBibliography(noProf)).toBe('"Course." Lecture, University, City, Province, Date.');
  });
});
