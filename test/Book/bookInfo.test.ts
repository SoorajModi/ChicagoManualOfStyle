...
let bookInfo = {edition: "Edition", publisher: "Publisher", placeOfPublication: "Place", yearOfPublication: "Year"};
let emptyBookInfo = {};
...
describe("bookInfo.bibliography() testing", () => {
    it("should generate bibliography citation with all fields specified", () => {
        expect(bookInfoBibliography(bookInfo)).toBe(" Edition. Place: Publisher, Year.");
    });
